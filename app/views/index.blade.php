        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Here you'll find a list of upcoming events around the world. Please click on an event for more information. Please sign up or log in to be able to view member-only events.</h3>
                </div>
            </div>
            <div class="row">
