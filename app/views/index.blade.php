    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Welcome To Our Society!</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Here you'll find a list of upcoming events around the world. Please sign up or log in to be able to create events.</h3>
                </div>
            </div>
            <div class="row">
            @if (count($events))
            ...
            @else
                <div class="col-lg-12 text-center">
                    <p>Sorry, no events are scheduled at this time. Please check back later.</p>
                </div>
            @endif
            </div>
        </div>
